...
async function runTests() {
    ...
    if (b1.booking_id === b2.booking_id)
    ...
    if (b1.base_price.toString() !== b1_after.base_price.toString())
        throw new Error("Pricing mutated!");
    ...
    if (b1.customer_name !== b1_after_cust.customer_name)
        throw new Error("Customer mutated!");
    // --- 5. Lead Conversion ---
