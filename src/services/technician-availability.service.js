...
export const checkAvailability = async (userId, cityId, startTime, durationMinutes, excludeJobId) => {
    ...
    const getHourInTZ = (d) => parseInt(new Intl.DateTimeFormat('en-US', { hour: 'numeric', hourCycle: 'h23', timeZone: BUSINESS_HOURS.TIMEZONE }).format(d), 10);
